...
class NewsDetector(models.Model):
    ...
    link_content = models.CharField(verbose_name='Link Content', max_length=500, blank=True)
    news_result = models.CharField(verbose_name='Validation Result', max_length=70, default='under going review', blank=True)
